...
- Designed and implemented an end-to-end machine learning pipeline for high-frequency cryptocurrency price direction prediction (BTC/USDT, ETH/USDT, BNB/USDT, ADA/USDT) across 1–15 minute horizons.
